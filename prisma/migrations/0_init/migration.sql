-- CreateTable
CREATE TABLE "email_plugin_setting" (
    ...
    CONSTRAINT "email_plugin_setting_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "email_plugin_setting" ADD CONSTRAINT "email_plugin_setting_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
